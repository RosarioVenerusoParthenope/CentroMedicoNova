...
class Paziente(models.Model):
    ...
    id_cartella_clinica = models.ForeignKey(CartellaClinica, on_delete=models.CASCADE, related_name='pazienti')
...
class VisitaMedica(models.Model):
    ...
    id_prenotazione = models.ForeignKey(Prenotazione, on_delete=models.CASCADE, related_name='visite_mediche')
    codice_sede = models.ForeignKey(Sede, on_delete=models.CASCADE, related_name='visite_mediche')
    id_cartella_clinica = models.ForeignKey(CartellaClinica, on_delete=models.CASCADE, related_name='visite_mediche')
...
class Fattura(models.Model):
    ...
    codice_visita = models.ForeignKey(VisitaMedica, on_delete=models.CASCADE, related_name='fatture')
